...
public class Person {
    ...
    // Schreibe dafür eine AgeNegativeException und Throw sie falls die person unter 0 Jahre ist
    ...
    public void setAge(int alter) {
        if (alter < 0) throw new AgeNegativeException("Alter darf nicht negativ sein");
        this.age = alter;
    }
