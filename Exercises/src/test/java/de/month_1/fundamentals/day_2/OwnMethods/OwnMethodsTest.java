...
public class OwnMethodsTest {
    ...
    void declared_methods_exists(String methodenName, Class<?> returnType, Class<?>[] parameter) {
        assertDoesNotThrow(() -> {
            Method methode = OwnMethods.class.getDeclaredMethod(methodenName, parameter);
    ...
    void mult_should_multiply(int x,int y){
        assertDoesNotThrow(()-> {
            Constructor constructor = OwnMethods.class.getDeclaredConstructor();
            constructor.setAccessible(true);
            OwnMethods obj =(OwnMethods) constructor.newInstance();

            Method multMethod = OwnMethods.class.getDeclaredMethod("mult", int.class, int.class);
    ...
    void multByTwo_should_multiply_with_two(int x){
        assertDoesNotThrow(()-> {
            ...
            Method multByTwoMethod = OwnMethods.class.getDeclaredMethod("multByTwo", int.class);
