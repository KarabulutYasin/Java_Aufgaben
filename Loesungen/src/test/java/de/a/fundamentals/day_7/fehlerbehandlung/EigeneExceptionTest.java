package de.a.fundamentals.day_7.fehlerbehandlung;
...
class EigeneExceptionTest {

    EigeneException objectUnderTest;

    @BeforeEach
    void setup(){
        objectUnderTest = new EigeneException();
    }
    ...
    void throwsOwnException(){
        try {
            Class clazz = Class.forName("de.a.fundamentals.day_7.fehlerbehandlung.exception.OwnException");
    ...
    void throwsOwnRuntimeException(){
        try {
            Class clazz = Class.forName("de.a.fundamentals.day_7.fehlerbehandlung.exception.OwnRuntimeException");
    ...
    void div_with_invalid_input_throws_ZeroDivisionException(int x, int y){
        try {
            Class clazz = Class.forName("de.a.fundamentals.day_7.fehlerbehandlung.exception.ZeroDivisionException");
